  ...
  countries: [
    {
      ...
      region: "Northern Europe", mapX: 51.4, mapY: 20.9,
    ...
    },
    {
      ...
      region: "Central America", mapX: 25.2, mapY: 42.4,
    ...
    },
    {
      ...
      region: "North America", mapX: 22.5, mapY: 39.2,
    ...
    },
    {
      ...
      region: "Central Europe", mapX: 53.7, mapY: 20.8,
    ...
    },
    {
      ...
      region: "Southern Europe", mapX: 53.5, mapY: 26.7,
    ...
    },
    {
      ...
      region: "Northern Europe", mapX: 48.3, mapY: 20.4,
    ...
    },
    {
      ...
      region: "East Asia", mapX: 88.8, mapY: 30.2,
    ...
    },
    {
      ...
      region: "North America", mapX: 29.4, mapY: 27.4,
    ...
    },
    {
      ...
      region: "North America", mapX: 25.7, mapY: 26.7,
    ...
    },
    {
      ...
      region: "North America", mapX: 17.2, mapY: 31.1,
...
/*
 * Renders the interactive "world map" — pins over a stylized (not
 * literal-cartographic) dot-matrix world map background. Used on the
 * homepage and on /explore.html so both share one implementation.
 *
...
window.UBC_WORLD.renderMap = function (containerId, opts) {
  ...
  root.innerHTML =
    '<div class="wm-surface">' +
      '<img class="wm-basemap" src="' + prefix + 'assets/img/world-dots.svg" alt="" aria-hidden="true">' +
      pins +
    '</div>' +
